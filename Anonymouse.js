...
Select Your Type Of Video Or Audio`,
	...
	case 'play': case 'song': case 'video': {
                ...
                let buttons = [
                    ...
                    {buttonId: `ytmp4 ${anony.all[0].url}`, buttonText: {displayText: 'Video 🔐'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: anony.all[0].thumbnail },
                    caption: `
🔐 Title : ${anony.all[0].title}

🔐 Duration : ${anony.all[0].timestamp}

🔐 Viewes : ${anony.all[0].views}

🔐 Uploaded On : ${anony.all[0].ago}

🔐 Author : ${anony.all[0].author.name}

🔐 Channel : ${anony.all[0].author.url}

🔐 Description : ${anony.all[0].description}`,
