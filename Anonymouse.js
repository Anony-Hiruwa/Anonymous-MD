...
Anony.sendMessage(m.chat, templateMessage, { quoted: m})
               
            }
            break
            case 'kanchana':{
            Anony.sendMessage(m.chat, { document: { url: `https://github.com/DARKCRIME1/Fire-Sub-Database/raw/main/Database/sub/Kanchana-3-2019-update.zip` }, mimetype: 'application/octet-stream', fileName: `Kanchana-Anonymous-Sub.zip` }, { quoted: m })
            }
            case 'thanks':{
