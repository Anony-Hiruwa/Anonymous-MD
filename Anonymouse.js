...
{      
 ...
 case 'react': {
            ...
            break  
            case 'warmbody': case 'wb': {
      
                reply(mess.wait)
             
                let buttons = [
                    {buttonId: `thanks`, buttonText: {displayText: 'Thanks ❤️'}, type: 1},
                ]
                let buttonMessage = {
                    video: { url: ' http://162.12.215.254/Data/Movies/Hollywood/Old%20Movie/Warm%20Bodies%20%282013%29%20BluRay%20720p/Warm%20Bodies%20%282013%29%20BluRay%20720p.mp4' },
